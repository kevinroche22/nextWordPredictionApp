...
* [03 - dataModeling.R](https://github.com/kevinroche22/SwiftkeyTextMiningAndAnalytics/blob/main/scripts/03%20-%20dataModeling.R) develops a Stupid Back Off (SBO) model to predict the next word in a sentence based off of the previous 5 words. The model is saved to the *models* folder.
